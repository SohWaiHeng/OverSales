...
import { faUser, faMapMarkerAlt, faBox, faDollarSign } from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            <Flex>
                <Box 
                    ...
                    margin = "20px 0px"
                    >
                    <Image height="200px" width="420px" rounded = "25px" borderEndStartRadius="sm" borderEndEndRadius="sm" src={property.imageUrl} alt={property.imageAlt} />
                    <br></br>
                    <Box margin="20px 20px 0px 50px">
